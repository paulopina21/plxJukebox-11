...
bool CYUV2RGBShader::Create(unsigned int sourceWidth, unsigned int sourceHeight, BufferFormat fmt)
{
  ...
  CStdString effectString = "special://root/system/shaders/yuv2rgb_d3d.fx";
...
bool CConvolutionShader1Pass::Create(ESCALINGMETHOD method)
{
  ...
  switch(method)
  {
    ...
    case VS_SCALINGMETHOD_LANCZOS3_FAST:
      effectString = "special://root/system/shaders/convolution-4x4_d3d.fx";
      break;
    case VS_SCALINGMETHOD_SPLINE36:
    case VS_SCALINGMETHOD_LANCZOS3:
      effectString = "special://root/system/shaders/convolution-6x6_d3d.fx";
      break;
    default:
...
bool CConvolutionShaderSeparable::Create(ESCALINGMETHOD method)
{
  ...
  switch(method)
  {
    ...
    case VS_SCALINGMETHOD_SPLINE36_FAST:
    case VS_SCALINGMETHOD_LANCZOS3_FAST:
      effectString = "special://root/system/shaders/convolutionsep-4x4_d3d.fx";
      break;
    case VS_SCALINGMETHOD_SPLINE36:
    case VS_SCALINGMETHOD_LANCZOS3:
      effectString = "special://root/system/shaders/convolutionsep-6x6_d3d.fx";
      break;
    default:
      CLog::Log(LOGERROR, __FUNCTION__": scaling method %d not supported.", method);
      return false;
...
{
  CStdString effectString = "special://root/system/shaders/testshader.fx";

...
extern "C" void __stdcall init_emu_environ()
{
  ...
  if (!CUtil::GetFrameworksPath(true).IsEmpty())
  {
    ...
    dll_putenv(string("PATH=.;" + _P("special://root") + ";" + _P("special://frameworks")).c_str());
  }
  else
  {
    dll_putenv(string("PYTHONPATH=" + _P("special://root/system/python/DLLs") + ";" + _P("special://root/system/python/Lib")).c_str());
    dll_putenv(string("PYTHONHOME=" + _P("special://root/system/python")).c_str());
    dll_putenv(string("PATH=.;" + _P("special://root") + ";" + _P("special://root/system/python")).c_str());
  }

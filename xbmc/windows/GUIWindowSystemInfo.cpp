  ...
  case GUI_MSG_WINDOW_INIT:
    {
      ...
      SET_CONTROL_LABEL(52, "Raven Jukebox Professional" + g_infoManager.GetLabel(SYSTEM_BUILD_VERSION) + " (Build : " + g_infoManager.GetLabel(SYSTEM_BUILD_DATE)+")");
#else
      SET_CONTROL_LABEL(52, "Raven " + g_infoManager.GetLabel(SYSTEM_BUILD_VERSION) + " (Compiled : " + g_infoManager.GetLabel(SYSTEM_BUILD_DATE)+")");
#endif
      return true;
    }
    break;

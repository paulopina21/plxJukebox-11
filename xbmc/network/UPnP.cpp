...
CUPnP::CreateServer(int port /* = 0 */)
{
    ...
    device->m_ModelName        = "Raven Media Center"; // Laureon: Refactor
    device->m_ModelNumber      = "1.0";
    device->m_ModelDescription = "Raven Media Server";
    device->m_ModelURL         = "http://plexusdynamics.com.br/";
    device->m_Manufacturer     = "PleXus Dynamics";
    device->m_ManufacturerURL  = "http://plexusdynamics.com.br/";
...
CUPnP::CreateRenderer(int port /* = 0 */)
{
    ...
    device->m_PresentationURL =
        NPT_HttpUrl(m_IP,
                    atoi(g_guiSettings.GetString("services.webserverport")),
                    "/").ToString();
    device->m_ModelName = "Raven"; // Laureon: Refactor
    device->m_ModelNumber = "2.0";
    device->m_ModelDescription = "Raven Media Renderer";
    device->m_ModelURL = "http://plexusdynamics.com.br/";
    device->m_Manufacturer = "PleXus Dynamics";
    device->m_ManufacturerURL = "http://plexusdynamics.com.br/";

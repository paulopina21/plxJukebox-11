...
#define WINDOW_SETTINGS_JUKEBOX_MANAGER   10020
#define WINDOW_SETTINGS_JUKEBOX_OPERATOR  10021

#define WINDOW_SCRIPTS                    10023 // virtual window for backward compatibility

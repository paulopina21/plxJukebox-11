...
static const ActionMapping windows[] =
       {{"home"                     , WINDOW_HOME},
        ...
        {"jukeboxsettings"       , WINDOW_SETTINGS_JUKEBOX_MANAGER},
        {"jukeboxoperator"       , WINDOW_SETTINGS_JUKEBOX_OPERATOR},
#endif
...
#define REMOTEMAP "IRSSmap.xml"
  ...
  URIUtils::AddFileToFolder("special://root/system/", REMOTEMAP, lircmapPath);

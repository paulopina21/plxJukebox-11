...
void XBPython::Initialize()
{
  ...
  if (!m_bInitialized)
  {
...
#ifndef _LINUX
      if(!FileExist("special://root/system/python/DLLs/_socket.pyd") ||
        !FileExist("special://root/system/python/DLLs/_ssl.pyd") ||
        !FileExist("special://root/system/python/DLLs/bz2.pyd") ||
        !FileExist("special://root/system/python/DLLs/pyexpat.pyd") ||
        !FileExist("special://root/system/python/DLLs/select.pyd") ||
        !FileExist("special://root/system/python/DLLs/unicodedata.pyd"))
      {
      ...
      // work this way
      CStdString buf;
      buf = "PYTHONPATH=" + _P("special://root/system/python/DLLs") + ";" + _P("special://root/system/python/Lib");
      pgwin32_putenv(buf.c_str());
      buf = "PYTHONOPTIMIZE=1";
      pgwin32_putenv(buf.c_str());
      buf = "PYTHONHOME=" + _P("special://root/system/python");
      pgwin32_putenv(buf.c_str());
      buf = "OS=win32";
      pgwin32_putenv(buf.c_str());

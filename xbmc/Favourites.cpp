...
bool CFavourites::Load(CFileItemList &items)
{
  ...
  favourites = "special://root/system/favourites.xml";
...
bool CFavourites::LoadFavourites(CStdString& strPath, CFileItemList& items)
{
  ...
  while (favourite)
  {
    ...
    // <favourite name="Apple Movie Trailers" thumb="path_to_thumb.png">RunScript(special://root/scripts/apple movie trailers/default.py)</favourite>

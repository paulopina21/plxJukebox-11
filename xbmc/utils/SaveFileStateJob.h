...
{
  if (!g_jukeboxManager.GetReportsManager().LogPlayedItem(&m_item)) return false; // Laureon: Jukebox Stats: Save execution stats here!
  ...
  if (progressTrackingFile != "")
  {
    ...
    if (m_item.IsAudio()) // Laureon: TODO: Verificar se é um arquivo dentro de um pfc e gravar mesmo se for video... colocar também uma lista de generos tocados
    {

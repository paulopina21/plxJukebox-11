...
bool CWinSystemX11::CreateNewWindow(const CStdString& name, bool fullScreen, RESOLUTION_INFO& res, PHANDLE_EVENT_FUNC userFunction)
{
  ...
  iconTexture.LoadFromFile("special://root/media/icon.png");
...
#ifdef IS_PROFESSIONAL // Laureon: Added: Jukebox: Windows Title
  SDL_WM_SetCaption("Raven Jukebox", NULL);
#else
  SDL_WM_SetCaption("Raven Media Center", NULL);
#endif
